    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-8 mt-2">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/') }}">Anya Fashion</a></li>
                <li class="breadcrumb-item"><a href="{{ url('barang') }}">List Baju</a></li>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @csrf
                                                ...
                                                <button type="submit" class="btn btn-dark btn-block mt-2 col-md-100" @if($barang->stok < 1) disabled @endif><i class="fa fa-shopping-cart"></i> Masukkan Keranjang</button>
                                            </form>
                                        </td>
                                    </tr>
