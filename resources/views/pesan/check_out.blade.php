                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $no++ }}</td>
                                <td>
                                    <img src="{{ url('assets/baju') }}/{{ $pesanan_detail->barang->gambar }}" width="80" alt="...">
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('konfirmasi-check-out') }}" class="btn btn-dark" onclick="return confirm('Anda yakin akan Check Out ?');">
