...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <a href="{{ url('history') }}" class="btn btn-dark"><i class="fa fa-arrow-left"></i> Kembali</a>
        </div>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6><strong>Nomer Rekening : 7821-03-12-247-20</strong></h6>
                    <h6><strong>Atas Nama : Samudera Dharma Putra</strong></h6>
